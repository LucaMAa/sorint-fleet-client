    ...
    <div className="auth-bg">
      <div className="auth-card">
        ...
        <div className="auth-footer">
          {mode === 'login' ? <>Non hai un account? <button onClick={() => { setMode('register'); setError('') }}>Registrati</button></> : <>Hai già un account? <button onClick={() => { setMode('login'); setError('') }}>Accedi</button></>}
        </div>
      </div>
    </div>
  )
